...
export const metadata = { title: 'New Project — Swethank OS' };
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-4 border-b border-ink/[0.07] px-8 py-5">
        ...
        <h1 className="text-[18px] font-semibold tracking-[-0.018em] text-ink">New project</h1>
      </div>

      <div className="px-8 py-8">
        <form action={createProjectAction} className="max-w-[640px] space-y-8">

          {/* Core */}
          <div className="space-y-5">
            <div>
              <label className={LABEL}>Title *</label>
              <input name="title" required placeholder="Project name" className={INPUT} />
            </div>
            <div>
              ...
              <textarea
                ...
                required
                rows={5}
                placeholder="What did you build, why does it matter, what are the key results?"
          ...
          <div className="border-t border-ink/[0.07] pt-7">
            ...
            <div className="mt-5">
              ...
              <input name="tags" placeholder="AI, PyTorch, Research" className={INPUT} />
            </div>
          </div>
          ...
          <div className="border-t border-ink/[0.07] pt-7">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input name="github" type="url" placeholder="https://github.com/..." className={INPUT} />
              </div>
              <div>
                <label className={LABEL}>Demo / Live URL</label>
                <input name="demo" type="url" placeholder="https://..." className={INPUT} />
              </div>
              <div>
          ...
          <div className="border-t border-ink/[0.07] pt-7">
            ...
            <div className="space-y-3">
              <label className="flex cursor-pointer items-center gap-3">
                <input type="checkbox" name="published" defaultChecked className="h-4 w-4 rounded accent-ink" />
                <div>
              ...
              <label className="flex cursor-pointer items-center gap-3">
                <input type="checkbox" name="featured" className="h-4 w-4 rounded accent-ink" />
                <div>
                  <p className="text-[14px] font-medium text-ink">Mark as featured</p>
